...
import com.wayne.apihub.modules.query.sql.SqlPageHelperFactory;
import com.wayne.apihub.modules.query.sql.CommonPageHelper;
...
public class SqlQueryHandler {
    ...
    public BaseResponse handle(SqlQueryRequest sqlQueryRequest) throws IOException {
        ...
        if (sqlApiHandler.getPageTag() == Constants.STATUS_ENABLE) {
    ...
    private String getContSql(String sql) {
        return String.format(Constants.COUNT_SQL_WRAPPER, sql);
    }
